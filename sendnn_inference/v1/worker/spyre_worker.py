...
class SpyreWorker(WorkerBase):
    ...
    def sample_tokens(self, grammar_output: "GrammarOutput | None") -> ModelRunnerOutput:
        ...
        This method delegates to the model runner's sample_tokens implementation.
        It is called by the vLLM engine after execute_model returns None and
        grammar preparation is complete.
        ...
        # Delegate to model runner if it implements sample_tokens
        if hasattr(self.model_runner, "sample_tokens"):
            return self.model_runner.sample_tokens(grammar_output)

        # Fallback for pooling models that don't need sampling
