...
def get_cpu_worker(
    ...
    """Get the worker for testing.

    Returns the worker instance. Tests should use worker.execute_model() to test
    the real code path with sampling separation. If access to the model runner is
    needed, use worker.model_runner.
    """
